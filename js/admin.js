...
if(editId){
  ...
  const { error } = await supabase.from("campaigns").update(updateData).eq("id", editId);
...
["eventTitle","eventDescription","eventKeywords","eventProbability","eventCooldown","eventSponsor"]
.forEach(id=>{
